...
// import '../bloc/update_employee_screen_bloc.dart';
...
//     selectRoleController.text = widget.employee.role;
//     joiningDateController.text = widget.employee.joiningDate;
//     exitDateController.text = widget.employee.exitDate ?? "Today";
//   }
//
...
//             onPressed: () async {
//               await context.read<UpdateEmployeeBloc>().deleteEmployee(widget.employee.id);
//               Navigator.pop(context); // Navigate back to the employee list screen
//             },
//           ),
//         ],
//       ),
